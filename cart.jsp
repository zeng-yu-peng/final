    ...
    <div class="wish_list_wrap">
      ...
      <div class="wish_list_contant">
        <table>
          <!-- 標題 -->
          <tr>
            <form name="car" method="post" action="member.jsp">
              <th>&nbsp;&nbsp;&nbsp;選擇</th>
              <th>商品信息</th>
              <th>數量</th>
              <th>單價(元)</th>
          ...
          <!-- first product -->
          <form name="car" method="POST" action="cart.jsp">
            <table>
              <tr>
                ...
                <td><a href="two.jsp"><input type="button" value="刪除" onclick="del()"></td>
              </tr>

              <!-- 第二個 -->
              <tr>
                <td style="border: 0px;"><input type="checkbox"></td>
          ...
          <a href="finish.jsp"><button id="finish">結帳</button></a>
      </div>
      <hr>
    </div>
  </section>
