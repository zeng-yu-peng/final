    ...
    <div class="s1">
      ...
      <div class="path">
        <h6 style="margin: 20px -140px 0;">
          <a href="../index.jsp">Home</a> > <a href="../manu/magazine.jsp">Magazine</a> > <a
            href="../manu/ebook.jsp">電子雜誌</a>>建築欣賞 > 《CORE INTERIOR空間》 1月號/2019第13期 (電子雜誌)
        </h6>
      </div>
      ...
      <div class="left">
        ...
        <div class="bookcontent">
          <h2>《CORE INTERIOR》1月號/2019第13期 (電子雜誌)</h2>
        ...
        <div class="left1">
          <div class="description">
            ...
            <p>
              ...
              <div>
                一本有關空間、建築、設計、藝術、時尚的雜誌..
                以跨界、多元角度的觀點與手法，報導台灣與世界各地的設計，並以一個點的原初發想概念，
                去貫穿、延伸出有趣的、具啓發性的、有創造性的設計與空間事物。
                <br><br>
              </div>
              ...
              <div class="acc">
                ...
                <div class="accc">
                  ...
                  <div>
                    藝文建設的那些事兒
                    確實，藝文建設可以改變一個城市，如同古根漢美術館所造成的畢爾包效應，
                    讓予人破敗印象的畢爾包鹹魚翻身，其灰姑娘般的城市復興故事令全球紛紛效仿，
                    爭先搶後地設計美輪美奐的藝術文化硬體設施，然而，興建之後呢？<br><br><br>
                    許多耗資耗時的文化建設最後只留下宏偉建築的印象，以及蚊子館的標籤。
                    關鍵就在於，足以改變城市的藝文建設之「建設」不僅止於硬體而已，
                    它還囊括了一系列政策和與之相對應的藝文活動推展計畫，
                    少了藝文活動在場內持續發生，沒有連結在地群眾，鹹魚翻身之後還是鹹魚。<br><br>
                    因此，我們進一步在本期People 單元專訪今次臺北雙年展的共同策展人吳瑪悧，
                    與讀者分享現代美術館在社會中能夠扮演什麼樣的角色，而非自限於其建築與概念本質，
                    成為孤立的藝術沉思場域。
                    <br>
                  </div><br>


                  <div class="slide_toggle" style="background:powderblue;border-radius: 10px; height: 30px;">Exhibition
                  </div>

                  <div>
                    <b>《拾藝作坊・隱於南園》 </b><br>─阿波羅畫廊<br><br>
                    <b>《光影東京！360°夢幻視覺系特展》 </b><br>─聯合數位文創<br><br>
                    <b>《跨界・美學 臺灣當代首飾展》 </b><br>─臺北當代工藝設計分館
                    <br><br>
