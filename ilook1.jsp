    ...
    <div class="s1">
      ...
      <div class="path">
        <h6 style="margin: 20px -140px 0;">
          <a href="../index.jsp">Home</a> > <a href="../manu/magazine.jsp">Magazine</a> > <a
            href="../manu/book.jsp">實體雜誌</a>>建築欣賞 > iLOOK電影 1月號/2021第159期 (電子雜誌)
        </h6>
      </div>
      ...
      <div class="left">
        ...
        <div class="bookimg" style="margin:150px 0 0 50px;">
          <img src="../img/books/ilook/ilook1.png">
        </div>

        <div class="bookcontent">
          <h2>iLOOK電影 1月號/2021第159期 (電子雜誌) </h2>
            ...
            <p>
              ...
              <div class="acc">
                ...
                <div class="accc">
                  ...
                  <div class="slide_toggle" style="background: lightyellow;border-radius: 10px; height: 30px;">Film
                    Talking
                  </div>
                  <div>
                  ...
                  <div class="slide_toggle" style="background:powderblue;border-radius: 10px; height: 30px;">Behind The
                    Scenes
                  </div>
    ...
    <div>
      ...
      <div class="detail">
        ...
        <p>
          ...
          <div class="date">出版日期&thinsp;&thinsp;&thinsp;:&nbsp;&nbsp;&thinsp;2021/01/01 <br></div>
          <p>
      </div>
      <div class="reviews">
        <hr>
