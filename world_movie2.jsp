...
<body>
    ...
    <section>
        ...
        <div class="manu" style="display:none" id="sidebar">
            ...
            <ul>
                <li><a href="index.html">商店介紹</a></li>
                <li><a href="../manu/newbook.html">全部商品</a>
                    <ul>
                        <li><a href="../manu/top.html">熱銷排行</a></li>
                        <li><a href="../manu/magazine.html">Magazine</a></li>
                        <li><a href="../manu/ebook.html">電子書</a></li>
                    </ul>
                </li>
                <li><a href="../store_detail/aboutus.html">認識我們</a></li>
                <li><a href="../store_detail/question.html">購物須知</a></li>
                <li><a href="../teams.html">BK.成員介紹</a></li>
    ...
    <header style="position: relative; top:0; left:0;">
        <hr>
        <div class="icon">
            <a href="../index.html"><img src="../img/shop.png" width="150px"></a>
        </div>

        <div class="wishlist" style="z-index: 100000000;">
            <a href="../member/wish_list.html" title="願望清單"><img src="../img/wishlist-12.png" width="100px"></a>
        </div>

        <div class="cartt" style="z-index: 200000000;">
            <a href="../member/cart.html" title="購物車"><img src="../img/carttt.png" width="100px"></a>
        </div>
    ...
    <section class="oooxxx">
        <div class="s1">
            <div class="ad1" style="margin: -80px -140px 0;">
                <a href="../manu/top_ebook.html"><img src="../img/ad1.gif" width="1380px"></a>
            </div>
            <div class="path">
                <h6 style="margin: 20px -140px 0;">
                    <a href="../index.html">Home</a> > <a href="../manu/newbook.html">Magazine</a> > <a
                        href="../manu/ebook.html">eBook</a> >影視偶像 </a> >世界電影 </a>>《世界電影》 2021年2月號第625期 (電子雜誌)
                </h6>
            </div>
            ...
            <div class="left">
                ...
                <div class="bookimg" style="margin:150px 0 0 40px;">
                    <img src="../img/books/movie/movie2.png">
                </div>

                <div class="bookcontent">
                    <h2>《世界電影》 2021年2月號第625期 (電子雜誌) </h2>
    ...
    <section class="ooxx">
                    ...
                    <div class="description">
                        ...
                        <p>
                            ...
                            <div class="textt">
                                ...
                                <br>那些引領風潮的時尚電影們<br>
                                好萊塢向來就是與時尚界密不可分，<br>
                                別說電影、影集中的人物角色穿著打扮妝髮設計，<br>
                                就連佈景建造與道具擺設等等的美術設計，<br>
                                同樣都是與時尚風潮息息相關的指標性存在。<br>
                                本月要介紹的，正是這些劇情以時尚為主的經典時尚電影，<br>
                                以及得以一窺時尚界內幕與設計大師等人生面相的紀錄片。
                            ...
                            <div class="acc">
                                ...
                                <div class="accc">
                                    ...
                                    <div>
                                        「我想做的只是一直拍電影，然後擁有愈來愈多觀眾。」<br>
                                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                        &nbsp;
                                        &nbsp; &nbsp;─導演阿莫多瓦談【慾望法則】<br><br>
                                        辛苦討生活的淘金者！當恐怖雨林遇上瘋狂喜劇的嶄新民族誌<br>
                                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; ─【野蠻糾碴隊】演員 文森德迪恩、愛麗絲貝萊迪 專訪<br><br><br></div>
                                    <br>
        ...
        <div>
            <div class="terms">
                ...
                <p>To see our available delivery options please <a href="../store_detail/question.html">Click here</a>
                </p>
            </div>
            ...
            <div class="re">
                ...
                <p>Please see our <a href="../store_detail/question.html"> Returns Policy.</a></p>
            </div>
