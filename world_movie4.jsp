    ...
    <div class="s1">
      ...
      <div class="path">
        <h6 style="margin: 20px -140px 0;">
          <a href="../index.jsp">Home</a> > <a href="../manu/newbook.jsp">Magazine</a> > <a
            href="../manu/ebook.jsp">eBook</a> >影視偶像 </a> >世界電影 </a>>《世界電影》 2021年2月號第625期 (電子雜誌)
        </h6>
      </div>
      ...
      <div class="left">
        ...
        <div class="bookimg" style="margin:150px 0 0 30px;">
          <img src="../img/books/movie/movie4.jpg">
        </div>

        <div class="bookcontent">
          <h2>《世界電影》 2021年4月號第627期 (電子雜誌) </h2>
      ...
      <div class="s2">
        <div class="left1">
          <div class="description">
            ...
            <h3>Description</h3>
            <p>
              <span style="background-color:rgb(218, 186, 226); font-size: 28px;">NO.627 APR 2021</span>
              <div class="texttt">
                &nbsp;&nbsp;<b>
                  真人快打<br>
                  全新世代 全面開打</b><br><br></div>
              ...
              <div class="textt">
                2021奧斯卡入圍特別報導
                <br>今年總計有8部作品入圍奧斯卡最佳影片獎項，<br>
                雖然稱不上皆大歡喜，<br>
                不過基本上已經算是令外界相當有感了。<br>
                以10項入圍拔得頭籌的是Netflix出品的【曼克】。<br>
              ...
              <div class="acc">
                ...
                <div class="accc">
                  ...
                  <div>
                    ...
                    <div>2021奧斯卡入圍特別報導:<BR>
                      今年總計有8部作品入圍奧斯卡最佳影片獎項，雖然稱不上皆大歡喜，不過基本上已經算是令外界相當有感了。以10項入圍拔得頭籌的是Netflix出品的【曼克】。
                    </div>
                  </div>
                  <br>

                  <div class="slide_toggle" style="background: lightyellow;border-radius: 10px; height: 30px;">MOVIE
                    FEATURE
                    電影特寫</div>

                  <div>
                    <img src="../img/icon/quiet.jpg" width="20px" style="padding-top: 1%; padding-right: 1%;">無名弒<br>
                    『煙囪小鎮的普佩降臨在萬聖節夜晚的小小奇蹟…』<br><br>

                    <img src="../img/icon/boogie.jpg" width="20px"
                      style="padding-top: 1%; padding-right: 1%;">煙囪小鎮的普佩<br>
                    『班奈狄克康柏拜區挑戰真實間諜角色，演繹被歷史埋沒的英雄！』<br><br>

                    <img src="../img/icon/hug.jpg" width="20px" style="padding-top: 1%; padding-right: 1%;">鐵幕行動
                    <br>
                    『【絕地戰警】系列編劇打造全新女英雄』<br><br>

                    <img src="../img/icon/wrath.jpg" width="20px" style="padding-top: 1%; padding-right: 1%;">惡夜殺神<br>
                    『韓國養生主廚林祉鎬的親情人生』<br><br>

                    <img src="../img/icon/childhood.jpg" width="20px"
                      style="padding-top: 1%; padding-right: 1%;">盡孝的滋味<br>
                    『繼【犬鳴村】後「恐怖村莊系列」第2彈』<br><br>

                    <img src="../img/icon/thief.jpg" width="20px" style="padding-top: 1%; padding-right: 1%;">樹海村<br>
                    『從動物視角呈現動物們的感受與情緒』<br><br>

                    <img src="../img/icon/hz.jpg" width="20px" style="padding-top: 1%; padding-right: 1%;">農場我的家<br>
                    『真相就藏在記憶的縫隙中……』<br><br>

                    <img src="../img/icon/crime.jpg" width="20px" style="padding-top: 1%; padding-right: 1%;">
                    佳麗村三姐妹<br>
                    『榮獲2004奧斯卡金像獎雙料大獎提名經典動畫』<br><br>

                    <img src="../img/icon/hz.jpg" width="20px" style="padding-top: 1%; padding-right: 1%;">郵差<br>
                    『影史經典4K修復重回大銀幕』<br><br>

                    <img src="../img/icon/hz.jpg" width="20px" style="padding-top: 1%; padding-right: 1%;">藥命交錯<br>
                    『醫界毒梟引爆全球致命危機』<br><br>
                  </div><br>

                  <div class="slide_toggle" style="background:plum;border-radius: 10px; height: 30px;">
                    INTERVIEW 人物專訪</div>
                  <div>
                    「為這個世代以及青春的暴衝留下完美的瞬間」<br>
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                    ─【透視畫男孩，全景畫女孩】導演瀨田夏樹 專訪<br> </div><br>

                  <div class="slide_toggle" style="background:powderblue;border-radius: 10px; height: 30px;"> COLUMN 專欄
                  </div>
                  <div>影迷藏寶圖<br>
                    科學怪人的百年孤寂 <br>
                    就是電影 <br>
    ...
    <div>
      ...
      <div class="detail">
        ...
        <p>
          ...
          <div class="date">出版日期&thinsp;&thinsp;&thinsp;&thinsp;:&nbsp;&nbsp;&thinsp;2021/02/01 <br></div>
          <p>
      </div>
      <div class="reviews">
        <hr>
