    ...
    <div class="s1">
      ...
      <div class="path">
        <h6 style="margin: 20px -140px 0;">
          <a href="../index.jsp">Home</a> > <a href="../manu/newbook.jsp">Magazine</a> > <a
            href="../manu/ebook.jsp">eBook</a> >影視偶像 </a> >世界電影 </a>>《世界電影》 2021年5月號第628期 (電子雜誌)
        </h6>
      </div>
      ...
      <div class="left">
        ...
        <div class="bookimg" style="margin:150px 0 0 30px;">
          <img src="../img/books/movie/movie5.jpg">
        </div>

        <div class="bookcontent">
          <h2>《世界電影》 2021年5月號第628期 (電子雜誌) </h2>
            ...
            <p>
              ...
              <div class="acc">
                ...
                <div class="accc">
                  ...
                  <div>
                    <img src="../img/icon/quiet.jpg" width="20px" style="padding-top: 1%; padding-right: 1%;">噤界II<br>
                    『保持安靜，不是唯一生存之道』<br><br>

                    <img src="../img/icon/boogie.jpg" width="20px" style="padding-top: 1%; padding-right: 1%;">布吉闖籃關<br>
                    『不論面臨什麼挑戰，都要越過那道高牆』<br><br>

                    <img src="../img/icon/hug.jpg" width="20px" style="padding-top: 1%; padding-right: 1%;">勇抱大地<br>
                    『一個關於人類善良本性以及生命韌性的故事』<br><br>

                    <img src="../img/icon/wrath.jpg" width="20px" style="padding-top: 1%; padding-right: 1%;">玩命鈔劫<br>
                    ...
                    <img src="../img/icon/hz.jpg" width="20px" style="padding-top: 1%; padding-right: 1%;">催魂頻率<br>
                    『真相就藏在記憶的縫隙中……』<br><br>

                    <img src="../img/icon/crime.jpg" width="20px" style="padding-top: 1%; padding-right: 1%;"> 罪之聲<br>
                  ...
                  <div>
                    ...
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; ─【野蠻糾碴隊】演員 文森德迪恩、愛麗絲貝萊迪 專訪<br><br><br></div><br>
    ...
    <div>
      ...
      <div class="detail">
        ...
        <p>
          ...
          <div class="date">出版日期&thinsp;&thinsp;&thinsp;&thinsp;:&nbsp;&nbsp;&thinsp;2021/05/10 <br></div>
          <p>
      </div>
      <div class="reviews">
        <hr>
